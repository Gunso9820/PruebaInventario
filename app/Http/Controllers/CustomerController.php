...
class CustomerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            return response()->json(['status'=>'success','message'=>'Trabajador agregado']);
        }
        catch(\Exception $e)
        {
    ...
    public function update(Request $request,$id)
    {
        ...
        try{
            ...
            return response()->json(['status'=>'success','message'=>'Información del Trabajador actualizada']);
        }
        catch(\Exception $e)
        {
    ...
    public function destroy($id)
{
    ...
    try {
        // Eliminar el cliente
        $customer->delete();
        return response()->json(['status' => 'success', 'message' => 'Trabajador eliminado']);
    } catch (\Exception $e) {
        return response()->json(['status' => 'error', 'message' => '¡Algo salió mal!']);
    }
}
